      ...
      <div className="flex items-center justify-center p-6 bg-white dark:bg-zinc-900">
        <div className="w-full max-w-md">
          <div className="mb-6 text-left">
            <Link href="/forgot-password" className="inline-flex items-center text-sm font-medium text-primary dark:text-purple-400 hover:underline">
          ...
          <h1 className="mb-2 text-3xl font-bold text-center text-slate-900 dark:text-white">Şifre Değiştir</h1>
          <p className="mb-8 text-center text-sm text-slate-500 dark:text-slate-400">Güvenliğiniz için yeni bir şifre belirleyin.</p>
